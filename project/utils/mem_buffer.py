...
class MemBuffer:
    ...
    def __init__(self, max_time, width=64, height=64, motion_blur=4, action_space_n=15):
        ...
        self.state_values = torch.zeros(self.max_length, dtype=torch.float).cuda()
    ...
    def set_next(self, state, next_state, state_value, reward, action, action_probs, action_log_prob, done, mask=None):
        ...
        self.state_values[self.t] = state_value
